...
connection_string = "Driver={ODBC Driver 18 for SQL Server};Server=tcp:satishsqlserver1.database.windows.net,1433;Database=satishdb;Uid=azureuser;Pwd={Satish@123};Encrypt=yes;TrustServerCertificate=no;Connection Timeout=30;"
